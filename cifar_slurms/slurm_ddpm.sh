...
options="--mode train --total_steps 650000 --batch_size 128 --lr 2e-4 --save_dir checkpoints --save_every 50000 --log_every 1000"
...
application="$PYTHON_EXEC -u run_cifar.py"
