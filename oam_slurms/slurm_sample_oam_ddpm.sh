...
MODE="sample_ddpm"       # "sample" or "denoise"
N_SAMPLES=16
...
CMD="$PYTHON_EXEC -u run_oam.py --mode $MODE --resume $CHECKPOINT --n_samples $N_SAMPLES --n_frames $N_FRAMES --output_dir $OUTPUT_DIR --image_size 128 --device cuda > logs/sample.$JOBID"
