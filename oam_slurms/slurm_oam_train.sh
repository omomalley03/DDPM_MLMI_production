...
#!
#! Trains a VAE on OAM laser beam intensity images (320x320 grayscale).
#! Architecture: 320->160->80->40->20, latent = 20x20x8
#!
...
options="--mode train_vae --mat_path $MAT_PATH --total_epochs 50 --batch_size 32 --lr 1e-4 --kl_weight 1e-4 --save_dir checkpoints_vae_oam_2 --log_every 50"
...
application="$PYTHON_EXEC -u run_oam.py"
